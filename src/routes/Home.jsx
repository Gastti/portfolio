  ...
  const info = [
    {
      ...
      eng: {
        ...
        subtitle:
          "I'm Gastón, Full Stack Developer passionate about creating solutions through programming.",
        button: "See Resume",
      },
    },
  ];
    ...
    <div>
      ...
      <div className='me-photo'>
        ...
        <div className="me-description">
          ...
          <Button type="dark" size="large" target="_blank" href="https://drive.google.com/file/d/1WmkJoWb5RfWmIdbRfDMEKro1MT8DRBH_/view?usp=sharing">
            {activeInfo.button}
          </Button>
        </div>
      </Section>
